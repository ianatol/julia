...
function escape_builtin!(::typeof(arrayref), astate::AnalysisState, pc::Int, args::Vector{Any})
    ...
    aryt = argtypes[2]
    if !array_builtin_common_typecheck(Core.Compiler.Arrayish, boundcheckt, aryt, argtypes, 3)
...
function escape_builtin!(::typeof(arrayset), astate::AnalysisState, pc::Int, args::Vector{Any})
    ...
    aryt = argtypes[2]
    valt = argtypes[3]
    if !(array_builtin_common_typecheck(Core.Compiler.Arrayish, boundcheckt, aryt, argtypes, 4) &&
