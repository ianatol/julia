...
extern JL_DLLEXPORT uint8_t jl_measure_compile_time_enabled;
extern JL_DLLEXPORT uint64_t jl_cumulative_compile_time;
...
extern const JL_DLLEXPORT int jl_tls_elf_support;
